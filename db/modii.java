...
class modii extends JFrame implements ActionListener{
		...
		if(btn.getText().equals("Add"))
			{
				...
				else
				{
					...
					JOptionPane.showMessageDialog(null,"Entered data Type is Invalid! Try Again ");
					setVisible(false);
					new modii();
					break label;
					}
					try{
						...
						st.executeUpdate("update mytable set Name='"+name+"'where id="+modi.r);	
						st.executeUpdate("update mytable set chem="+b+" where id="+modi.r);
						st.executeUpdate("update mytable set phy="+c+" where id="+modi.r);
						st.executeUpdate("update mytable set mat="+d+" where id="+modi.r);				
						st.executeUpdate("update mytable set ps="+e+" where id="+modi.r);
						st.executeUpdate("update mytable set bio="+f+" where id="+modi.r);
						st.executeUpdate("update mytable set id="+a+" where id="+modi.r);
						con.close();
						st.close();
